...
const BRANCHES = [
  { d: `M${TREE_X + 1} 238 C ${TREE_X - 30} 228, ${TREE_X - 70} 224, ${TREE_X - 98} 204`, end: [TREE_X - 108, 198], Icon: LayoutGrid, label: 'система' },
  { d: `M${TREE_X + 1} 238 C ${TREE_X + 30} 226, ${TREE_X + 56} 212, ${TREE_X + 76} 190`, end: [TREE_X + 86, 182], Icon: Wallet, label: 'деньги' },
  { d: `M${TREE_X + 2} 206 C ${TREE_X - 22} 186, ${TREE_X - 52} 170, ${TREE_X - 74} 142`, end: [TREE_X - 84, 132], Icon: Target, label: 'решения' },
  { d: `M${TREE_X + 2} 206 C ${TREE_X + 26} 180, ${TREE_X + 46} 158, ${TREE_X + 60} 124`, end: [TREE_X + 66, 112], Icon: Workflow, label: 'автоматизация' },
  { d: `M${TREE_X} 172 C ${TREE_X - 10} 140, ${TREE_X - 26} 112, ${TREE_X - 40} 86`, end: [TREE_X - 46, 74], Icon: Gauge, label: 'скорость' },
  { d: `M${TREE_X} 160 C ${TREE_X + 8} 130, ${TREE_X + 18} 100, ${TREE_X + 30} 74`, end: [TREE_X + 36, 62], Icon: Users, label: 'ресурсы' },
] as const
...
export function SproutsTree() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Четыре ростка: три увядают, четвёртый вырастает в дерево с шестью ветвями — система, деньги, решения, автоматизация, скорость, ресурсы"
    >
