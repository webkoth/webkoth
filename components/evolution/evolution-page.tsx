  ...
  return (
    <>
      ...
      <main className="relative z-[1] min-h-screen" lang={lang}>
        <HeaderNav lang={lang} brand={data.brand} cta={data.nav.cta} stepsAria={data.nav.stepsAria} items={navItems} />

        <Hero data={data.hero} />

        <BlockSection block={data.blocks.system} labels={data.labels} animation={<FragmentsToStructure copy={a.fragments} />} />
        <BlockSection block={data.blocks.money} labels={data.labels} animation={<FogToDashboard copy={a.fog} />} />
        <BlockSection
        ...
        <BlockSection
          ...
          exhibit={<LaunchTableExhibit data={data.exhibits.launchTable} />}
        />
        <BlockSection
