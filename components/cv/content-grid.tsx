...
const Icons: Record<string, React.ReactElement> = {
  youtube: (
    <svg viewBox="0 0 24 24" className="size-4" fill="#ff0033" aria-hidden="true">
  ...
  npm: (
    <svg viewBox="0 0 24 24" className="size-4" fill="#cb3837" aria-hidden="true">
      <path d="M1.763 0C.786 0 0 .786 0 1.763v20.474C0 23.214.786 24 1.763 24h20.474c.977 0 1.763-.786 1.763-1.763V1.763C24 .786 23.214 0 22.237 0zM5.13 5.323l13.837.019-.009 13.836h-3.464l.01-10.382h-3.456L12.04 19.17H5.113z"/>
    </svg>
  ),
  telegram: (
    <svg viewBox="0 0 24 24" className="size-4" fill="#26a5e4" aria-hidden="true">
  ...
  blog: (
    <svg viewBox="0 0 24 24" className="size-4 fill-foreground" aria-hidden="true">
      <path d="M4 2h12l4 4v16H4V2zm12 0v4h4M6 9h12v2H6V9zm0 4h12v2H6v-2zm0 4h8v2H6v-2z"/>
    </svg>
  ),
};
