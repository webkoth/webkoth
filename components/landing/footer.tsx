...
const SOCIAL = [
  {
    key: "github",
    href: "https://github.com/webkoth",
    label: "GitHub",
    icon: GithubIcon,
  },
  {
    key: "telegram",
    href: "https://t.me/webkoth",
    label: "Telegram",
    icon: Send,
  },
  {
    key: "youtube",
    href: "https://www.youtube.com/@msarkisyan",
    label: "YouTube",
    icon: YoutubeIcon,
  },
] as const;
  ...
  return (
    <footer className="border-t border-border">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-10 md:flex-row md:items-center md:justify-between md:px-8">
        ...
        <p className="font-mono text-xs text-muted-foreground">{t.copyright}</p>
      </div>
    </footer>
  );
}
