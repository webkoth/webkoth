...
export const en: EvolutionData = {
  ...
  labels: {
    ...
    caseAlsoInOne: 'The same system pays off on one more step',
    carouselAria: 'Cases for this step',
    carouselPrev: 'Previous case',
    carouselNext: 'Next case',
    carouselCounter: '{i} of {n}',
    carouselGoTo: 'Case {i}',
    caseBackAria: 'Back to the step',
    caseKindRow: 'Type',
    caseStatusRow: 'Status',
    caseEffectsTitle: 'Effect across the steps',
    caseValueTitle: 'What the business gets',
    caseDiagramTitle: 'From source to result',
    caseBeforeAfterTitle: 'By hand, then one button',
    caseBeforeTitle: 'Before: by hand, every day',
    caseAfterTitle: 'Now: one button',
    caseScreensTitle: 'Interface',
    caseHowTitle: 'How it works',
    caseOwnerTitle: 'Who maintains it now',
    caseSiblingsTitle: 'Other cases for this step',
  },
  ...
  exhibits: {
    launchTable: {
      ...
      rows: [
        ['Management finance loop', '13 Jul', '14 Jul', '1 day'],
