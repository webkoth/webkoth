...
export const kontur: LandingCopy = {
  meta: {
    title: 'Отчёты Wildberries, Ozon и Маркета в 1С со сверкой выплат · webkoth',
    description:
      'Отчёты о реализации Wildberries, Ozon и Яндекс Маркета сами попадают в 1С по расписанию и сверяются с выплатами площадок. Данные у вас. Разбор бесплатно.',
  },
  nav: { quiz: 'Разобрать процесс', how: 'Как это работает', cases: 'Кейсы', pricing: 'Цены', faq: 'Вопросы', cta: 'Заявка' },
  hero: {
    eyebrow: '1С · Wildberries · Ozon · Маркет',
    title: 'Отчёты Wildberries, Ozon и Маркета сами попадают в 1С и сходятся с выплатами',
    sub: 'Отчёты о реализации, комиссии, логистика и возвраты попадают в 1С по расписанию, без ручных выгрузок. Расхождения с выплатами площадок видны сразу, данные остаются у вас.',
    primaryCta: 'Оставить заявку',
    secondaryCta: 'Написать в Telegram',
  },
  // Числа выдуманы и подписаны «Пример»; разницы и строку «К перечислению» считает компонент.
  reconciliation: {
    badge: 'Пример',
    title: 'Сверка недели · Wildberries',
    head: ['Статья', 'Отчёт площадки', 'В 1С', 'Разница'],
    rows: [
      { label: 'Продажи', report: 486200, oneC: 486200 },
      { label: 'Комиссия', report: -58344, oneC: -58344 },
      { label: 'Логистика', report: -41870, oneC: -39520 },
      { label: 'Штрафы', report: -3000, oneC: 0 },
    ],
    total: 'К перечислению',
    mismatch: 'Расхождение',
    verdict: 'в 1С нет 2 350 ₽ логистики и штрафа на 3 000 ₽',
  },
  // Над карточкой угла «деньги»: заголовок карточки уже говорит «сходятся до копейки», здесь не повторяем.
  heroCase: { eyebrow: 'Кейс', title: 'Сверка с площадкой уже работает у торговой компании' },
  quiz: {
    eyebrow: 'Три минуты',
  ...
  lead: {
    eyebrow: 'Заявка',
    title: 'Разобрать ваш контур',
    sub: 'Напишите, какие системы у вас есть и что не сходится. Отвечаю в тот же день.',
    fieldsNote: 'Необязательно, но поможет подготовиться к разбору.',
    fields: [
      { key: 'onec', label: 'Какая 1С', placeholder: 'УТ 11, УНФ, Бухгалтерия, КА…' },
      { key: 'marketplaces', label: 'Площадки', placeholder: 'Wildberries, Ozon, Маркет' },
      { key: 'turnover', label: 'Оборот в месяц', placeholder: 'например, 3 млн ₽' },
    ],
  },
}
