...
export const standardData: Record<Lang, StandardData> = {
  ru: {
    ...
    aiNote:
      '«AI» в названии говорит об эпохе, а не о том, что ИИ ставится в каждый шаг: стандарт так же часто запрещает ИИ, как назначает.',
    contents: {
      title: 'Что внутри',
      cards: [
        {
        ...
        },
        {
          ...
          text: 'Инструменты автора с честными статусами и таблица альтернатив по формам; сам стандарт нейтрален к инструментам.',
    ...
    start: {
      ...
      steps: [
        ...
        'Пройдите восемь вопросов по схеме и получите вердикт по шагам.',
        'Сверьтесь с ближайшей карточкой библиотеки: она подскажет, что требовать при внедрении и приёмке.',
      ],
      offer:
        'Или короче: разбор одного вашего процесса по стандарту, бесплатно, 30 минут. Паспорт, вердикт и план дальнейших шагов остаются у вас.',
    },
    guide: {
      title: 'Гид владельца',
  ...
  en: {
    ...
    contents: {
      ...
      cards: [
        ...
        },
        {
          ...
          text: 'The author’s tools with honest statuses and a table of alternatives per form; the standard itself is tool-agnostic.',
          href: `${AIAS_REPO_URL}/tree/main/stack`,
    ...
    start: {
      ...
      steps: [
        ...
        'Walk the eight questions on the diagram and get a per-step verdict.',
        'Compare with the closest library card: it tells you what to demand at delivery and acceptance.',
      ],
      offer:
    ...
    guide: {
      title: 'Owner’s guide',
      text: 'A 40-minute read. The print version is 20 A4 pages with a table of contents.',
