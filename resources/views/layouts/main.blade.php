...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-gray-50">
    <head>
        ...
        <meta name="twitter:description" content="Beautiful UI components and templates by the creators of Webkoth UI." inertia>
    ...
    <body class="h-full">
            ...
            <div x-show="isOpen" x-transition:enter="transition ease-in-out duration-300 transform"
                ...
                <nav class="flex flex-col flex-1">
                    ...
                    <li>
                        ...
                        <li>
                            <a href="#" class="flex p-2 text-sm font-semibold leading-6 text-indigo-600 rounded-md bg-gray-50 group gap-x-3">
                            <svg class="w-6 h-6 text-indigo-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <li>
                            <a href="#" class="flex p-2 text-sm font-semibold leading-6 text-gray-700 rounded-md hover:text-indigo-600 hover:bg-gray-50 group gap-x-3">
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div class="flex items-center h-16 shrink-0">
                ...
                <a href="#" class="flex p-2 text-3xl font-bold leading-6 text-teal-600 rounded-md bg-gray-50 group gap-x-3">
                    WebkothUI
                </a>
            </div>
            <nav class="flex flex-col flex-1">
                ...
                <li>
                    ...
                    <li>
                        <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                        <a href="#" class="flex p-2 text-sm font-semibold leading-6 text-teal-600 rounded-md hover:text-teal-600 bg-gray-50 group gap-x-3">
                        Accordion
                        </a>
                    </li>
                    <li>
